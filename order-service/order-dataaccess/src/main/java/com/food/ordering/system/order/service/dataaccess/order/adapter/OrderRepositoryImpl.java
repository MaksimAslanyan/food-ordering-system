...
import com.food.ordering.system.order.service.dataaccess.restaurant.repository.OrderJpaRepository;
...
//        return orderJpaRepository.findById((UUID) orderId.getValue())
//            .map(orderDataAccessMapper::orderEntityToOrder);
//    }
}