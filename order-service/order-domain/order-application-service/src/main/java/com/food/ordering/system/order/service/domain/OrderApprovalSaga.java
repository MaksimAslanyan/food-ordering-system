...
import com.food.ordering.system.order.service.domain.outbox.sceduler.approval.ApprovalOutboxHelper;
...
import static com.entity.DomainConstants.UTC;
    ...
    private OrderCancelledEvent rollbackOrder(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        OrderCancelledEvent orderCancelledEvent =
            orderDomainService.cancelOrderPayment(order,
                                                  restaurantApprovalResponse.getFailureMessage());
        orderSagaHelper.saveOrder(order);
